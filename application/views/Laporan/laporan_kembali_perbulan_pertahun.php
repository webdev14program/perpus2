    ...
    <div class="col-md">
        <div class="card">
            <div class="card-body bg-primary">
                <h4 class="text-center text-uppercase text-white font-weight-bold">Laporan Pengembalian Buku</h4>
            </div>
        </div>
    </div>
</div>
                    ...
                    <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <?php
                                $no = 1;
                                foreach ($laporan_kembali as $row) {
                                ?>
                                    ...
                                    <td class=" text-uppercase font-weight-bold">
                                        <h5 class="text-center">
                                            <a class="text-uppercase font-weight-bold btn btn-danger text-white btn-sm" href="<?= base_url() ?>Dashboard/print_laporan_kembali/<?= $row['bulan_tahun'] ?>" target="_blank"><i class="fas fa-print"></i> Print</a>
                                        </h5>
                                    </td>
                            </tr>
                        <?php } ?>
